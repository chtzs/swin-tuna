...
class PromptConfig:
    def __init__(self):
        ...
        self.DEEP = False # "whether do deep prompt or not, only for prepend location"
        ...
        self.DROPOUT = 0.0
        self.SAVE_FOR_EACH_EPOCH = False

@MODELS.register_module() 
class PromptedSwinTransformer(SwinTransformer, BaseModule):
    def __init__(
        self, prompt_config=PromptConfig(), img_size=224, patch_size=4, in_chans=3,
